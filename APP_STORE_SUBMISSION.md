...
#### Description
```
Pergamene is a focused Bible reading app featuring the Brenton Septuagint (Old Testament) and Berean Standard Bible (New Testament). Experience scripture in a beautiful, distraction-free environment designed for deep reading and meditation.
...
• Optional verse numbers in margins
• Dark gradient overlay for comfortable reading
